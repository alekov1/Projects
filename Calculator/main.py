...
class Calculator:
    def __init__(self, master):
        ...
        self.eqution = StringVar()
        self.entry_value = ''
        Entry(width=100,  bg='lightblue', font=('Arial Bold', 28), fg='black', textvariable=self.eqution).place(x=0,y=0)
        ...
        Button(width=11, height=4, text='9', relief='flat', bg='white', command=lambda: self.show(8)).place(x=180, y=275)
        Button(width=7, height=4, text='8', relief='flat', bg='white', command=lambda: self.show(9)).place(x=90, y=275)
        ...
        Button(width=7, height=4, text='C', relief='flat', command=self.clear).place(x=0, y=350)

    def show(self, value):
        self.entry_value += str(value)
        self.eqution.set(self.entry_value)
